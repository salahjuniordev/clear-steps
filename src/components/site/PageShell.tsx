      ...
      <div className="mt-12">
        {children ?? (
          <div className="rounded-3xl bg-card ring-1 ring-border p-10 sm:p-14 shadow-soft text-center max-w-2xl">
            ...
            <h2 className="mt-5 text-xl font-semibold text-primary">Section en construction</h2>
            <p className="mt-2 text-sm text-foreground/70">
              Cette page sera bientôt disponible. Contenu, données et intégrations Lovable Cloud à venir.
            </p>
            <Button asChild variant="hero" className="mt-6">
              <Link to="/">Explorer la plateforme</Link>
            </Button>
          </div>
        )}
      </div>
